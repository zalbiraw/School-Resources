...
public:
    ...
    //My functions 
    double evaluateCubicB(double) const;
    double evaluateBetaB(double) const;
    Vector2D evaluateClosed(double) const;
    Vector2D evaluatePhantom(double) const;
    void drawBspline(int) const;
    Vector2D evaluateBspline(int, double) const;
